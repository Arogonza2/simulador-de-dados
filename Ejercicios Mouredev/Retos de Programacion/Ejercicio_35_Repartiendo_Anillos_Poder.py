...
def distributed_rings(total_rings: int):
    ...
    return "No es posible repartir los anillos de poder."
    
try:    
    total_rings = int(
        input(" Introduce el numero de anillos que quieres rapartir: ")
    )
    distributed_rings = distributed_rings(total_rings)
